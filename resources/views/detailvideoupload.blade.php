    ...
    <div class="main-content">
        ...
        <form id="postDetailsForm">
            ...
            <div class="content-grid">
                <div class="details-section">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="hashtags" name="hashtags" placeholder="Hastags" value="{{ $videoFashion->tag ?? '' }}">
                    </div>
                    <div class="form-group">
            ...
            <div class="action-buttons">
                ...
                <button type="button" class="post-button" id="postButton">Post</button>
            </div>
        </form>
    </div>
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            postButton.addEventListener('click', async (e) => {
                ...
                if (videoId && videoId !== 0) {
                    formData.append('idVideoFashion', videoId);
                }
