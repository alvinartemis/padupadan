<div class="user-list-grid" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(100px, 1fr)); gap: 15px;">
    @forelse ($usersToChat as $user) {{-- Use @forelse here --}}
        <a href="{{ route('chat.showChatUser', ['user' => $user->idPengguna]) }}" style="text-decoration: none; color: inherit;">
    ...
    @empty {{-- This block will execute if $usersToChat is empty --}}
