...
<head>
    ...
    <style>
        ...
        .upload-content-area {
            flex-grow: 1;
            padding: 40px 60px; /* Padding ini sudah bagus, namun akan saya sesuaikan lagi untuk responsivitas */
            display: flex;
            flex-direction: column;
            align-items: center;
            background-color: #f0f2f5;
            ...
            padding: 20px; /* Padding di semua sisi untuk area konten */
        }

        .upload-content-area h2 {
            display: none; /* Menyembunyikan judul "Upload New Content" */
        }
        ...
        .upload-card {
            ...
            width: 100%;
            max-width: 900px; /* Lebar maksimal sedikit diperkecil */
            text-align: center;
            margin-bottom: 20px; /* Margin bawah tetap untuk info-grid */
            box-sizing: border-box;
            display: flex;
            flex-direction: column;
            align-items: center;
            flex-grow: 1; /* Biarkan card mengisi ruang yang tersedia secara vertikal */
            justify-content: center; /* Pusatkan konten di dalam card */
        }

        /* Tambahkan style untuk form agar tidak membatasi tinggi card */
        .upload-card form {
            width: 100%;
            height: 100%; /* Form mengisi tinggi card */
            display: flex;
            flex-direction: column;
            align-items: center;
        ...
        .upload-box {
            ...
            align-items: center;
            justify-content: center;
            width: 80%; /* Mengurangi lebar upload-box di dalam card agar tidak terlalu lebar */
            max-width: 500px; /* Batasi lebar maksimal upload-box */
            height: auto; /* Tinggi auto, tidak perlu fix height 50% */
            min-height: 250px; /* Tinggi minimum yang cukup */
            margin-bottom: 0; /* Hapus margin-bottom di sini */
        }
        ...
        /* Informasi tambahan di bawah card upload */
        .info-grid {
            width: 100%;
            max-width: 900px; /* Sesuaikan dengan max-width upload-card */
            display: grid;
            grid-template-columns: repeat(auto-fit, minmax(200px, 1fr));
            gap: 20px;
            margin-top: 20px; /* Jarak dari card di atasnya */
        ...
        @media (max-width: 768px) {
            ...
            .upload-card {
                ...
                width: 100%;
                height: auto;
                flex-grow: 0; /* Tidak perlu mengisi sisa ruang di mobile */
            }
            .upload-content-area h2 {
                display: none;
            }
            .upload-box {
                width: 100%;
                height: auto;
                min-height: 200px; /* Tinggi minimum disesuaikan untuk mobile */
            }
            .info-grid {
                width: 100%;
...
<body>
    ...
    <script>
        // JavaScript for file upload preview and drag/drop
        ...
        selectVideoButton.addEventListener('click', (e) => {
            e.stopPropagation(); // Mencegah event click propagate ke uploadBox
            mediaUpload.click(); // Memicu klik pada input file tersembunyi
        });

        // Event listener untuk klik pada uploadBox
        uploadBox.addEventListener('click', (e) => {
            // Hanya memicu input file jika klik bukan pada tombol "Select video" atau input file itu sendiri
            if (e.target !== mediaUpload && e.target !== selectVideoButton) {
                mediaUpload.click();
            }
        });
        ...
        mediaUpload.addEventListener('change', function() {
            ...
            if (file) {
                ...
                reader.onload = function(e) {
                    ...
                    // Sembunyikan teks, subtitle, ikon, dan tombol saat preview ditampilkan
                ...
                // Tampilkan kembali elemen-elemen yang disembunyikan
